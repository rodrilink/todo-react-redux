...
const SignInPage = ({signInByPass, signInWithGithub, signInWithGoogle, signInWithTwitter}) => {
  return (
    <div className="g-row sign-in">
      <div className="g-col">
        <h1 className="sign-in__heading">Sign in</h1>
        <Button className="sign-in__button" onClick={signInByPass}>Pasale!</Button>
...
SignInPage.propTypes = {
  signInByPass: PropTypes.func.isRequired,
...
const mapDispatchToProps = {
  signInByPass: authActions.signInByPass,
